...
import { Shield, AlertTriangle, ArrowLeft, Phone } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-red-50 border-l-4 border-red-500 p-4 m-4 rounded-xl">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-semibold text-red-900 text-sm mb-1">Emergency Disclaimer</h3>
            <p className="text-xs text-green-700">
              This app gives health awareness only. Not a doctor. Call 108 in emergencies.
            </p>
          </div>
        </div>
      ...
      <div className="px-6 py-4">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-xl font-bold">Login & Profile</h1>
        </div>
        ...
        {step === 'login' ? (
          <div className="space-y-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">
                Welcome to Swasthya Sathi
              </h2>
              <p className="text-sm text-green-600">
                Your Indian health companion. Start by verifying your mobile number.
              </p>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center py-2">
              <p className="text-xs font-semibold text-green-600 tracking-wider">PROFILE DETAILS</p>
            </div>
